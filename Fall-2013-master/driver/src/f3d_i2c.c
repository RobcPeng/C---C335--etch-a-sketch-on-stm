 ...
 * Maintainer: Kevin Kapoun and Robert Peng
 * Created: Thu Oct 31 09:10:53 2013
 * Last-Updated: 10/31/13
 *           By: Kevin Kapoun and Robert chengyuan Peng
 *     Update #: 0
 * Keywords: 
 * Compatibility: 
 * 
...
void f3d_i2c1_init() {
 ...
 //GPIO Initialization
  ...
  //setting alternate functions for pins pb6 and pb7
